...
var (
	...
	predefinedImages = []DevContainerImage{
		...
		{
			Name:        "PHP (Latest) [Composer + Symfony]",
			Image:       "mcr.microsoft.com/devcontainers/php:latest",
			DefaultPort: "8000",
			Settings:    "",
			PostCommand: "composer install && symfony check:requirements",
			Features:    `{"ghcr.io/devcontainers/features/node:1": {"version": "20"}, "ghcr.io/devcontainers/features/git:1": {}, "ghcr.io/shyim/devcontainers-features/symfony-cli:0": {}}`,
		},
		{
			Name:        "Go [Alpine]",
			Image:       "golang:alpine",
